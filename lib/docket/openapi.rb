    ...
    def components
      {
        ...
        schemas: {
          Case: object_schema(
            ...
            category_id: :integer, category: :string, assignee_id: :integer, owner_id: :integer,
            contact_id: :integer,
          ...
          Contact: object_schema(
            ...
            organisation_id: :integer, owner_id: :integer, preferred_language: :string, notes: :string,
          ...
          Sequence: object_schema(id: :integer, name: :string, active: :boolean,
                                  owner_id: :integer, business_calendar_id: :integer,
          ...
          User: object_schema(id: :integer, name: :string, email_address: :string,
                              ...
                              record_read_scope: enum(User.record_read_scopes.keys),
                              record_write_scope: enum(User.record_write_scopes.keys),
                              queue_ids: { type: "array", items: { type: "integer" } },
                              team_ids: { type: "array", items: { type: "integer" } },
                              scoped_account_ids: { type: "array", items: { type: "integer" } },
                              created_at: :datetime, updated_at: :datetime),
